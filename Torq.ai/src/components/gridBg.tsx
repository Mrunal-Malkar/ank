...
export function GridBackground() {
    ...
    <div className="relative flex h-[50rem] w-full items-center justify-center bg-white dark:bg-black">
      ...
      <p className="relative z-2 flex flex-col gap-y-2 bg-gradient-to-b from-neutral-200 to-neutral-500 bg-clip-text py-8 text-8xl font-bold text-transparent sm:text-9xl">
        Torq
      </p>
